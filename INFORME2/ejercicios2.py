...
def generar_multiplos(numero):

  return [numero * i for i in range(1, 10 + 1)]

numero = int(input("Ingrese el número: "))

print(generar_multiplos(numero))
...
zapatos = int(input("Numero de zapatos vendidos: "))
tenis = int(input("Numero de tenis vendidos: "))
camisas = int(input("Numero de camisas vendidas: "))
corbatas = int(input("Numero de corbatas  vendidas: "))
pantalones = int(input("Numero de pantalones vendidos: "))
blusas  = int(input("Numero de blusas vendidas: "))
vestidos  = int(input("Numero de vestidos vendidos: "))
...
def calcularSalario(Nombre, cantidadArticulos):
    ...
    Salario = (1380000 + zapatos * 5000 + tenis * 2800 + camisas * 2400 + corbatas * 1750 + pantalones * 1750 + blusas * 2400 + vestidos * 1900)
    diccionario = {"nombre": Nombre, "salario": Salario}
    return diccionario

#Ejemplo
Salario=calcularSalario (Nombre, cantidadArticulos)
print(Salario)